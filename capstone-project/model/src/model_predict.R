...
ModelPrediction <- function(text) {
  ...
  return(list(model = model, sampled = sampled, words_vectors = words_vectors, words  = words, maxlen = maxlen, word_vectors_size = word_vectors_size, preds = preds, class_weight = class_weight))
}